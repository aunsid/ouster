...
message(STATUS "ouster_ros: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iouster_ros:/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/kinetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg/PacketMsg.msg" NAME_WE)
add_custom_target(_ouster_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ouster_ros" "/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg/PacketMsg.msg" ""
)
...
_generate_msg_cpp(ouster_ros
  "/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg/PacketMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_java(ouster_ros
  "/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg/PacketMsg.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/ouster_ros
)

### Generating Services

### Generating Module File
_generate_module_java(ouster_ros
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/ouster_ros
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(ouster_ros_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(ouster_ros_generate_messages ouster_ros_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/nuc/ouster_ws/src/ouster_example/ouster_ros/msg/PacketMsg.msg" NAME_WE)
add_dependencies(ouster_ros_generate_messages_java _ouster_ros_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ouster_ros_genjava)
add_dependencies(ouster_ros_genjava ouster_ros_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ouster_ros_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/ouster_ros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/ouster_ros
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(ouster_ros_generate_messages_java std_msgs_generate_messages_java)
endif()
if(TARGET sensor_msgs_generate_messages_java)
  add_dependencies(ouster_ros_generate_messages_java sensor_msgs_generate_messages_java)
endif()
